...
class ConfigurationCompass {
  ...
  Iterable<_CompassCandidate> _candidatesFor(
    ...
    return switch (slot) {
      ...
      ConfigurationCompassSlot.agentDeterminer => _determinerCandidates(
        sentence.agent,
        NounPhraseTarget.agent,
      ),
      ConfigurationCompassSlot.agentAdjective => _adjectiveCandidates(
        sentence.agent,
        NounPhraseTarget.agent,
      ),
  ...
  Iterable<_CompassCandidate> _topicCandidates(SentenceState sentence) {
    ...
    final authoredOnChoices = _nounChoicesForPath(
      sentence,
...
final _defaultRecipients = [
  ...
  enemy.toNounPhrase(Number.singular),
...
final _defaultComplements = [
  doctor.toNounPhrase(Number.singular),

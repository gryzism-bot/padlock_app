...
final _writeObjects = _uniqueByText([
...
final _breakableObjects = _uniqueByText([
  ...
  object_data.door.toNounPhrase(Number.plural),
  ...
  object_data.bottle.toNounPhrase(Number.plural),
  object_data.cup.toNounPhrase(Number.singular),
  object_data.cup.toNounPhrase(Number.plural),
  object_data.glass.toNounPhrase(Number.singular),
  object_data.glass.toNounPhrase(Number.plural),
  object_data.plate.toNounPhrase(Number.singular),
  object_data.plate.toNounPhrase(Number.plural),
  object_data.box.toNounPhrase(Number.singular),
  object_data.box.toNounPhrase(Number.plural),
  object_data.bag.toNounPhrase(Number.singular),
  object_data.bag.toNounPhrase(Number.plural),
  object_data.wallet.toNounPhrase(Number.singular),
  object_data.wallet.toNounPhrase(Number.plural),
  object_data.drawer.toNounPhrase(Number.singular),
  object_data.drawer.toNounPhrase(Number.plural),
  object_data.cabinet.toNounPhrase(Number.singular),
  object_data.cabinet.toNounPhrase(Number.plural),
  object_data.package.toNounPhrase(Number.singular),
  object_data.package.toNounPhrase(Number.plural),
  object_data.suitcase.toNounPhrase(Number.singular),
  object_data.suitcase.toNounPhrase(Number.plural),
  object_data.fridge.toNounPhrase(Number.singular),
  object_data.fridge.toNounPhrase(Number.plural),
  ...object_categories.singularDeviceObjects,
  ...object_categories.pluralDeviceObjects,
  object_data.table.toNounPhrase(Number.singular),
  object_data.table.toNounPhrase(Number.plural),
  object_data.chair.toNounPhrase(Number.singular),
  object_data.chair.toNounPhrase(Number.plural),
  object_data.bed.toNounPhrase(Number.singular),
  object_data.bed.toNounPhrase(Number.plural),
  object_data.desk.toNounPhrase(Number.singular),
  object_data.desk.toNounPhrase(Number.plural),
  object_data.sofa.toNounPhrase(Number.singular),
  object_data.sofa.toNounPhrase(Number.plural),
  object_data.lamp.toNounPhrase(Number.singular),
  object_data.lamp.toNounPhrase(Number.plural),
  object_data.shelf.toNounPhrase(Number.singular),
  object_data.shelf.toNounPhrase(Number.plural),
]);
...
final _losableObjects = _uniqueByText([
  ..._genericObjects,
  ...object_pronouns.reflexivePronouns,
  ..._moneyObjects,
  object_data.key.toNounPhrase(Number.singular),
  object_data.key.toNounPhrase(Number.plural),
  object_data.phone.toNounPhrase(Number.singular),
  object_data.phone.toNounPhrase(Number.plural),
  object_data.card.toNounPhrase(Number.singular),
  ...
  object_data.bag.toNounPhrase(Number.singular),
  object_data.bag.toNounPhrase(Number.plural),
  object_data.schoolbag.toNounPhrase(Number.singular),
...
final _makeFoodObjects = _uniqueByText([
  fixed_object.breakfast,
  fixed_object.dinnerNoun,
...
final essentialPredicatePathMigration = [
  ...
  _migration(
    ...
    readiness: PredicatePathReadiness.seeded,
    note:
        'seeded physical breakable object, instrument, manner, particle, and time tracks',
  ),
  _migration(
    verb: begin,
    readiness: PredicatePathReadiness.pendingHandAuthored,
  ...
  _migration(
    ...
    readiness: PredicatePathReadiness.pendingHandAuthored,
    note:
        'authored wanted-object, right-action, companion, object-source, object-beneficiary, and time tracks',
  ),
  _migration(
    verb: need,
    readiness: PredicatePathReadiness.pendingHandAuthored,
  ...
  _migration(
    verb: lose,
    readiness: PredicatePathReadiness.seeded,
    note: 'seeded losable object, location, manner, and time tracks',
  ),
];

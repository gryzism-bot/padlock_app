...
void main() {
  ...
  group('Configuration Compass', () {
    ...
    test('guided semantic object rail is owned by predicate path shelves', () {
      ...
      expect(objectLabelsFor(have), contains('phone'));
      expect(objectLabelsFor(have), isNot(contains('waiting')));

      expect(objectLabelsFor(get), contains('message'));
      expect(objectLabelsFor(get), isNot(contains('noise')));

      expect(objectLabelsFor(buy), contains('apple'));
      expect(objectLabelsFor(buy), isNot(contains('waiting')));

      expect(objectLabelsFor(sell), contains('house'));
      expect(objectLabelsFor(sell), isNot(contains('yes')));

      expect(objectLabelsFor(want), contains('book'));
      expect(objectLabelsFor(want), isNot(contains('noise')));
      expect(objectLabelsFor(want), isNot(contains('yes')));

      expect(objectLabelsFor(need), contains('key'));
      ...
      expect(objectLabelsFor(make), contains('cake'));
      expect(objectLabelsFor(make), contains('coffee'));
      expect(objectLabelsFor(make), contains('gift'));
      expect(objectLabelsFor(make), contains('document'));
      expect(objectLabelsFor(make), isNot(contains('apple')));
      ...
      expect(objectLabelsFor(know), contains('cat'));
      expect(objectLabelsFor(know), contains('English'));
      expect(objectLabelsFor(know), contains('grammar'));
      expect(objectLabelsFor(know), contains('answer'));
      expect(objectLabelsFor(know), contains('question'));
      expect(objectLabelsFor(know), isNot(contains('phone')));
      expect(objectLabelsFor(know), isNot(contains('key')));
      expect(objectLabelsFor(know), isNot(contains('bread')));
      expect(objectLabelsFor(know), isNot(contains('money')));

      expect(objectLabelsFor(remember), contains('something'));
      expect(objectLabelsFor(remember), contains('Mary'));
      expect(objectLabelsFor(remember), contains('cat'));
      expect(objectLabelsFor(remember), contains('English'));
      expect(objectLabelsFor(remember), contains('grammar'));
      expect(objectLabelsFor(remember), contains('story'));
      expect(objectLabelsFor(remember), isNot(contains('phone')));
      expect(objectLabelsFor(remember), isNot(contains('key')));
      expect(objectLabelsFor(remember), isNot(contains('bread')));
      expect(objectLabelsFor(remember), isNot(contains('newspaper')));
      expect(objectLabelsFor(remember), isNot(contains('money')));

      expect(objectLabelsFor(forget), contains('something'));
      expect(objectLabelsFor(forget), contains('Mary'));
      expect(objectLabelsFor(forget), contains('cat'));
      expect(objectLabelsFor(forget), contains('English'));
      expect(objectLabelsFor(forget), contains('grammar'));
      expect(objectLabelsFor(forget), contains('story'));
      expect(objectLabelsFor(forget), isNot(contains('phone')));
      expect(objectLabelsFor(forget), isNot(contains('key')));
      expect(objectLabelsFor(forget), isNot(contains('bread')));
      expect(objectLabelsFor(forget), isNot(contains('newspaper')));
      expect(objectLabelsFor(forget), isNot(contains('money')));
      ...
      expect(objectLabelsFor(write), contains('email'));
      expect(objectLabelsFor(write), contains('code'));
      expect(objectLabelsFor(write), contains('something'));
      expect(objectLabelsFor(write), isNot(contains('newspaper')));
      expect(objectLabelsFor(write), isNot(contains('magazine')));
      expect(objectLabelsFor(write), isNot(contains('website')));
      expect(objectLabelsFor(write), isNot(contains('phone')));
      expect(objectLabelsFor(write), isNot(contains('bread')));
      expect(objectLabelsFor(write), isNot(contains('money')));

      expect(objectLabelsFor(use), contains('something'));
      expect(objectLabelsFor(use), contains('phone'));
      expect(objectLabelsFor(use), contains('computer'));
      expect(objectLabelsFor(use), contains('key'));
      expect(objectLabelsFor(use), contains('keyboard'));
      expect(objectLabelsFor(use), isNot(contains('apple')));
      expect(objectLabelsFor(use), isNot(contains('bread')));
      expect(objectLabelsFor(use), isNot(contains('story')));
      expect(objectLabelsFor(use), isNot(contains('money')));

      expect(objectLabelsFor(watch), contains('something'));
      ...
      expect(objectLabelsFor(see), contains('something'));
      expect(objectLabelsFor(see), contains('John'));
      expect(objectLabelsFor(see), contains('cat'));
      expect(objectLabelsFor(see), contains('problem'));
      expect(objectLabelsFor(see), contains('apple'));
      expect(objectLabelsFor(see), contains('key'));
      expect(objectLabelsFor(see), isNot(contains('yes')));
      expect(objectLabelsFor(see), isNot(contains('noise')));
      expect(objectLabelsFor(see), isNot(contains('waiting')));

      expect(objectLabelsFor(findVerb), contains('something'));
      expect(objectLabelsFor(findVerb), contains('book'));
      expect(objectLabelsFor(findVerb), contains('books'));
      expect(objectLabelsFor(findVerb), contains('key'));
      expect(objectLabelsFor(findVerb), contains('keys'));
      expect(objectLabelsFor(findVerb), contains('money'));
      expect(objectLabelsFor(findVerb), contains('someone'));
      expect(objectLabelsFor(findVerb), isNot(contains('bread')));
    ...
    test('get object-gated rails wake after an object exists', () {
      final authoredCompass = ConfigurationCompass(
        predicatePathMode: PredicatePathMode.authoredTracks,
      );
      var state = lock.applyMove(
      ...
      expect(
        render(
          sourcePlaceSuggestions
              .firstWhere((suggestion) => suggestion.label == 'from school')
              .preview,
        ),
        'You get book from school.',
      );
    });

    test('do object-gated rails wake after an object exists', () {
      final authoredCompass = ConfigurationCompass(
        predicatePathMode: PredicatePathMode.authoredTracks,
      );
      var state = lock.applyMove(
        ConfigurationState.initial(),
        const SetAction(doVerb),
      );
      ...
      state = lock.applyMove(state, SetObject(fixed_object.something));

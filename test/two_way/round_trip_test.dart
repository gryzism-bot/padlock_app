  ...
  group('Two-way one-predicate contract', () {
    ...
    test('noun phrases and phrases stay inside the two-way contract', () {
      expectSentenceRoundTrips([
        ...
        'John listened to Mary.',
        'John explained grammar to Mary.',
        ...
        'John works for Mary.',
        'She sang for the old teacher.',
        'They should have read for him.',
        'Football was played for Mary by John.',
        'John learns from Mary.',
        'She heard from the old teacher.',
        'They should have got a book from him.',
        'A book was taken from Mary by John.',
        'You get something.',
        'You got it.',
        'You got money from Mary.',
        'You get a book for John.',
        'You got money for school.',
        'You get something for fun.',
        'You use a key for work.',
        'She used computer for the new skill.',
        'A key was used for exercise by John.',
        'You learn for school.',
        'They run for health.',
        'She cooked bread for dinner.',
        'You took a book to Mary.',
        'Mary brought a book to John.',
        'You made Mary a cake.',
        'You made a cake for Mary.',
        'John made a gift for her.',
        'They made a plan for work.',
        'She made food for dinner.',
        'She made something for fun.',
        'They made him calm.',
        'They read for school.',
        'John agreed with Mary.',
        'John spoke quietly to Mary.',
        'John agreed politely with Mary.',
        'John spoke well with Mary.',
        'Mary wrote a letter with a pen.',
        'You write a letter with Mary with a pencil.',
        'You write note carefully.',
        'You write down note carefully.',
        'You look carefully.',
        'You pick phone carefully.',
        'A door was opened with a key by John.',
        'She cut bread with a knife.',
        'Mary went quietly to school.',
        'Mary went silently to John.',
        'Mary went to him.',
        'Mary travelled silently to John.',
        'Mary has travelled to school.',
        'I want to go.',
        'She needs to work.',
        'They liked to swim.',
